...
export const modals = [
    ...
    {
        thumbnail: imgSistemaBarberCard,
        figures: [
            {
    ...
    {
        thumbnail: imgJ7InformaticaCard,
        figures: [
            {
